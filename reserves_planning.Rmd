...
The highest cost planning units has a values of $`r max_pu_cost` million Austrailian dollars.
...
```{r}
# print the value of the cell locatedin the 30th row and the 60th column of the first layer
